...
/**
 * Created by zgx on 2016/1/25.
 */
@Controller
@SessionAttributes(value = {"userbase64","user_id","user"})
public class MissiveLookerController {
    @Autowired
    ...
    //MissiveDelContoller missiveDelContoller=new MissiveDelContoller();
    @RequestMapping(value="/dbzx/{itemActive}/{pageNum}/{pageNum1}")
