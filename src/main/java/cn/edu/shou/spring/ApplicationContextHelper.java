...
public class ApplicationContextHelper implements ApplicationContextAware {
    ...
    public static <T> T getBean(Class<T> clz) {
        ...
        ApplicationContextHolder sss=ApplicationContextHolder.getInstance();
        ApplicationContextHolder.getInstance().getApplicationContext().getBean(clz);
