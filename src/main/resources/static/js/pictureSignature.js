...
function openPictureSignatureWindow(option) {
    ...
    var pad_img_url=option.pad_img_url||"";
    var pad_img_left=option.pad_img_left||0;
    var pad_img_top=option.pad_img_top||0;
    var pad_img_width=option.pad_img_width||1030;
    var width_scale=signElementWidth/imgElementWidth;
    var height_scale=signElementHeight/imgElementHeight;
    width_scale=height_scale=1;//为了方便调整位置，先不设比例
...
//        console.log(e);
    ...
    var signElement_size=820*378
    var pad_img=document.createElement('div');
    $(pad_img).css({
        "position":"absolute",
        "left":0,
        "width": signElementWidth + 'px',
        "height": signElementHeight + "px",
        "background-image":"url("+pad_img_url+")",
        "background-position-x":width_scale * pad_img_left+"px",
        "background-position-y":height_scale * pad_img_top+"px",
        "background-size":width_scale * pad_img_width + "px auto"
       // "background-size":signElement_size / (width_scale * height_scale) + "px auto"
    });
//    console.log(width_scale,pad_img_width)
    $(pad_img).appendTo($(SWindow))
...
function openPictureSignatureWindow_missiveRecieve_leader(option) {
    ...
    var pad_img_width=option.pad_img_width||1030;
    var width_scale=signElementWidth/imgElementWidth;
    var height_scale1=signElementHeight/imgElementHeight;
    width_scale=height_scale1=1;//为了方便调整位置，先不设比例
...
//            ,"background-size":810*height_scale+"px "+603*height_scale+"px"
    ...
    $(pad_img).css({
        ...
        "background-image":"url("+pad_img_url+")",
        "background-position-x":width_scale * pad_img_left+"px",
        "background-position-y":height_scale1 * pad_img_top+"px",
        "background-size":width_scale * pad_img_width + "px auto"
        // "background-size":signElement_size / (width_scale * height_scale) + "px auto"
    });
...
function openPictureSignatureWindow_missivePublish_counterSign(option) {
    //为了迅速完成*******
    var signElement = option.sElement;
    signElementWidth = option.sWidth;
    //signElementWidth=790;
    ...
    $(bg_base).css(
        {
            ...
            "width":signElementWidth,
            "height":signElementHeight,
            "background-image":"url(/img/missivePublish_bg.png)",

            "background-repeat":"no-repeat"
            //,"background-size":810*height_scale+"px "+603*height_scale+"px"
            //,"background-position-x":(-8)*height_scale+"px"
            ,"background-size":825+"px "+458+"px"
            //,"background-position-x":(-8)*height_scale+"px"
...
//    var office_lable = document.createElement("lable");
//    try{
//        $(office_lable).html($("#mainSend_Person_lable").html());
//        $(office_lable).css(
//            {
//                "position": "absolute",
//                "left": "0px",
...
//                "margin": "0px",
//                "padding": "0px",
//                "font-size":($("#mainSend_Person_lable").css("font-size")).substring(0, ($("#mainSend_Person_lable").css("font-size")).length - 2)*height_scale+"px",
//                "height":($("#mainSend_Person_lable").css("height")).substring(0, ($("#mainSend_Person_lable").css("height")).length - 2)*height_scale+"px",
//                "width":($("#mainSend_Person_lable").css("width")).substring(0, ($("#mainSend_Person_lable").css("width")).length - 2)*height_scale+"px"
//            }
//        );
//    }
//    catch (e){}
...
//    var signatureTextdiv = document.createElement("textarea");
//    $(signatureTextdiv).css({"position": "absolute", "left": "0px", "margin": "0px", "padding": "0px", "border": "none;","top":"8px","width":"825px","height":"458px"});
//    var text_div_top = 0;
//    try {
//        $(signatureTextdiv).val($("#" + textareaElement).val());
//        var temp_top = $("#" + textareaElement).parent().css("top");
...
//    $(signatureTextdiv).appendTo($(SWindow));
    ...
    var signatureTextdiv1 = document.createElement("textarea");
    $(signatureTextdiv1).css({"position": "absolute", "left": "0px", "margin": "0px", "padding": "0px", "border": "none","background":'none',"top":"30px"});
    var text_fontSize = 18;
    var text_fontfamily = "SimSun";
    try {
//        console.log(textareaElement);
        textvalue = $("#" + textareaElement).val();
        $(signatureTextdiv1).val($("#" + textareaElement).val());
        var temp_fontsize = $("#" + textareaElement).css("font-size");
        text_fontSize = temp_fontsize.substring(0, temp_fontsize.length - 2);
//        console.log(text_fontSize);
        text_fontfamily = $("#" + textareaElement).css("font-family");
...
//        console.log(e);
    ...
    $(signatureTextdiv1).css({
        "width": signElementWidth + 'px',
        "height": signElementHeight + "px",
        "font-size": text_fontSize * signElementHeight / imgElementHeight + "px",
        "font-family": text_fontfamily
    })
    $(signatureTextdiv1).appendTo($(SWindow));




//    var signatureTextdiv2 = document.createElement("textarea");
//    $(signatureTextdiv2).css({"position": "absolute", "left": "0px", "margin": "0px", "padding": "0px", "border": "none","background":'none'});
//    var text_fontSize = 18;
//    var text_fontfamily = "SimSun";
//    try {
////        console.log(textareaElement);
//        textvalue = $("#" + textareaElement).val();
//        $(signatureTextdiv2).val($("#" + textareaElement).val());
//        var temp_fontsize = $("#" + textareaElement).css("font-size");
//        text_fontSize = temp_fontsize.substring(0, temp_fontsize.length - 2);
////        console.log(text_fontSize);
//        text_fontfamily = $("#" + textareaElement).css("font-family");
...
//    }
//
//    $(signatureTextdiv2).css({
//        "width": signElementWidth + 'px',
//        "height": signElementHeight + "px",
//        "font-size": text_fontSize * signElementHeight / imgElementHeight + "px",
//        "font-family": text_fontfamily
//    })
//    $(signatureTextdiv2).appendTo($(SWindow));
